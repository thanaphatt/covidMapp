...
ol.proj.get("EPSG:4326").setExtent([99.685343, 13.320918, 101.099340, 14.211703]);
var wms_layers = [];
...
lyr__1.set('fieldAliases', {'จังหวัด': 'จังหวัด', 'จำนวน': 'จำนวน', });
lyr__2.set('fieldAliases', {'จังหวัด': 'จังหวัด', 'จำนวน': 'จำนวน', });
lyr__3.set('fieldAliases', {'จังหวัด': 'จังหวัด', 'จำนวน': 'จำนวน', });
lyr__4.set('fieldAliases', {'จังหวัด': 'จังหวัด', 'จำนวน': 'จำนวน', });
lyr__1.set('fieldImages', {'จังหวัด': 'TextEdit', 'จำนวน': 'Range', });
lyr__2.set('fieldImages', {'จังหวัด': 'TextEdit', 'จำนวน': 'Range', });
lyr__3.set('fieldImages', {'จังหวัด': 'TextEdit', 'จำนวน': 'Range', });
lyr__4.set('fieldImages', {'จังหวัด': 'TextEdit', 'จำนวน': 'Range', });
lyr__1.set('fieldLabels', {'จังหวัด': 'header label', 'จำนวน': 'inline label', });
lyr__2.set('fieldLabels', {'จังหวัด': 'header label', 'จำนวน': 'inline label', });
lyr__3.set('fieldLabels', {'จังหวัด': 'inline label', 'จำนวน': 'inline label', });
lyr__4.set('fieldLabels', {'จังหวัด': 'inline label', 'จำนวน': 'inline label', });
